...
gulp.task('merge-source', function () {
    return gulp.src([
        "src/engine/core.js",
        "src/engine/audio.js",
        "src/engine/engine-defaults.js",
        ...
        "src/engine/texture.js",
        "src/engine/vertex-buffer.js",
        "src/engine/layer-manager.js",
        "src/common/network.js",
        "src/common/utils.js",
        "src/objects/camera.js",
        "src/objects/light.js",
        "src/objects/scene.js",
        "src/objects/game-objects/game-object-set.js",
        "src/objects/game-objects/game-object.js",
        "src/objects/game-objects/particle.js",
        "src/objects/game-objects/tiled-game-object.js",
        "src/objects/game-objects/parallax-game-objects.js",
        "src/components/component.js",
        "src/components/shaders/simple-shader.js",
        "src/components/shaders/texture-shader.js",
        "src/components/shaders/sprite-shader.js",
        "src/components/shaders/light-shader.js",
        "src/components/shaders/illum-shader.js",
        "src/components/shaders/phong-shader.js",
        "src/components/renderer/material.js",
        "src/components/renderer/renderer.js",
        "src/components/renderer/texture-renderer.js",
        "src/components/renderer/sprite-renderer.js",
        "src/components/renderer/light-renderer.js",
        "src/components/renderer/illum-renderer.js",
        "src/components/renderer/phong-renderer.js",
        "src/components/renderer/map-renderer.js",
        "src/components/renderables/font-renderable.js",
        "src/components/particle-emiter.js",
        "src/components/animation.js",
...
gulp.task('merge-dep', function () {
    return gulp.src(['lib/twgl-full.js',
     'lib/decomp.js',
      'lib/matter.js',
       'lib/matter-collision-events.js',
        'lib/stats.js'])
        .pipe(concat('dep.js'))
        .pipe(minify())
        .pipe(gulp.dest('build'))
...
gulp.task('merge-dep-min', function () {
...
gulp.task('hiddeIt',function(){
    return gulp.src(["build/dep-min.js","build/engine-min.js","build/game-min.js"])
        .pipe(concat('source.js'))
        .pipe(javascriptObfuscator())
        .pipe(gulp.dest('build'))        
});

gulp.task('offuscate', gulp.series('merge-dep', 'merge-source','merge-game','hiddeIt'));