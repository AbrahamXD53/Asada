function Particle(options = {}) {
    ...
    this.mGravityScale = options.gravity || [0, 0];
...
Particle.prototype.update = function (delta) {
    ...
    if (!this.usePhysics) {
        ...
        this.mTransform.translateX(this.mGravityScale[0]);
        this.mGravityScale[1] *= 1.01;
        this.mTransform.translateY(this.mGravityScale[1]);
